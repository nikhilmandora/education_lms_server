    ...
    .map((course, index) => (
      (
        <Card className="mt-6 w-30">
          ...
          <CardBody>
            <Typography variant="h4" color="blue-gray" className="mb-2 text-[blue] underline">
              {course.coursename}
            </Typography>
            ...
            <Typography variant="h6" color="blue-gray" className="mb-1 text-[gray]">
      ...
      <div className='max-w-[1300px] m-auto   mt-4 py-5'>
        <div className='grid grid-cols-[73%_auto] gap-4'>
          <div className=' py-5 px-4'>
            ...
            <div className='grid grid-cols-3 gap-3 mt-[40px] d-flex'>
              {displayCourses}
            </div>
            <ReactPaginate
              ...
              containerClassName={'paginationBttns bg-gradient-to-r from-light-blue-500 to-light-blue-500 py-1 px-4 rounded text-[blue] font-bold'}
              previousLinkClassName={'previousBttn hover:bg-blue-700 text-[blue] hover:text-[white] font-bold py-2 px-4 rounded'}
              nextLinkClassName={'nextBttn hover:bg-blue-700 text-[blue] hover:text-[white] font-bold py-2 px-4 rounded'}
